...
function BrandPanel() {
  return (
    <div className="hidden md:flex md:w-1/2 bg-gradient-to-br from-blue-600 via-blue-800 to-indigo-900 flex-col items-center justify-center p-10 relative overflow-hidden">
      ...
      <div className="w-full max-w-md">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-5" noValidate>
          ...
          <button type="submit" disabled={isSubmitting}
            className="w-full flex items-center justify-center gap-2 py-3 rounded-xl bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white font-semibold text-sm shadow-md shadow-blue-300 transition-all disabled:opacity-60 disabled:cursor-not-allowed mt-1">
            {isSubmitting
