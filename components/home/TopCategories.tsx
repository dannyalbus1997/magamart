...
/* Icon + color mapping for known categories */
const CATEGORY_META: Record<string, { bg: string; icon: React.ReactNode }> = {
  ...
  Fashion: {
    ...
    icon: (
      <svg viewBox="0 0 60 60" className="w-10 h-10" fill="none">
        <path d="M20 15 L10 28 L20 28 L18 50 L42 50 L40 28 L50 28 L40 15 Q35 20 30 18 Q25 20 20 15Z" fill="#f9a8d4" stroke="#ec4899" strokeWidth="1.5" />
        <path d="M24 15 Q30 22 36 15" stroke="#ec4899" strokeWidth="1.5" fill="none" strokeLinecap="round" />
      </svg>
    ),
  },
  Furniture: {
  ...
  "Daily Essentials": {
    ...
    icon: (
      <svg viewBox="0 0 60 60" className="w-10 h-10" fill="none">
        <path d="M12 33 Q12 48 30 49 Q48 48 48 33 Z" fill="#92400e" />
        <path d="M12 33 Q12 30 30 30 Q48 30 48 33" fill="#b45309" />
        <circle cx="23" cy="24" r="8" fill="#ef4444" />
        <circle cx="35" cy="22" r="7" fill="#f97316" />
      </svg>
    ),
  },
  "Home & Kitchen": {
    ...
    icon: (
      <svg viewBox="0 0 60 60" className="w-10 h-10" fill="none">
        <ellipse cx="30" cy="42" rx="18" ry="6" fill="#fed7aa" stroke="#f97316" strokeWidth="1.5" />
        <path d="M12 42 Q12 28 30 26 Q48 28 48 42" fill="#fff7ed" stroke="#f97316" strokeWidth="1.5" />
        <line x1="30" y1="10" x2="30" y2="26" stroke="#6b7280" strokeWidth="2.5" strokeLinecap="round" />
        <line x1="22" y1="14" x2="22" y2="26" stroke="#6b7280" strokeWidth="2" strokeLinecap="round" />
        <line x1="38" y1="14" x2="38" y2="26" stroke="#6b7280" strokeWidth="2" strokeLinecap="round" />
      </svg>
    ),
  },
  Sports: {
    ...
    icon: (
      <svg viewBox="0 0 60 60" className="w-10 h-10" fill="none">
        <circle cx="30" cy="32" r="18" fill="white" stroke="#10b981" strokeWidth="2" />
        <path d="M12 32 Q18 22 30 20 Q42 22 48 32" stroke="#10b981" strokeWidth="1.5" fill="none" />
        <path d="M12 32 Q18 42 30 44 Q42 42 48 32" stroke="#10b981" strokeWidth="1.5" fill="none" />
        <line x1="30" y1="14" x2="30" y2="50" stroke="#10b981" strokeWidth="1.5" />
      </svg>
    ),
  },
  Beauty: {
    ...
    icon: (
      <svg viewBox="0 0 60 60" className="w-10 h-10" fill="none">
        <path d="M30 8 L34 20 L46 20 L36 28 L40 40 L30 32 L20 40 L24 28 L14 20 L26 20 Z" fill="#c4b5fd" stroke="#a78bfa" strokeWidth="1" />
      </svg>
    ),
  },
  Groceries: {
    ...
    icon: (
      <svg viewBox="0 0 60 60" className="w-10 h-10" fill="none">
        <path d="M10 20 L14 46 Q14 50 18 50 L42 50 Q46 50 46 46 L50 20 Z" fill="#ecfccb" stroke="#84cc16" strokeWidth="1.5" />
        <path d="M20 20 Q20 12 30 12 Q40 12 40 20" stroke="#84cc16" strokeWidth="2" fill="none" strokeLinecap="round" />
        <circle cx="24" cy="34" r="4" fill="#84cc16" />
        <circle cx="36" cy="34" r="4" fill="#4ade80" />
          ...
          <div className="grid grid-cols-4 sm:grid-cols-5 md:grid-cols-7 gap-4">
            {categories.map((cat) => {
              ...
              return (
                <Link
                  key={cat}
                  href={`${paths.products}?category=${encodeURIComponent(cat)}`}
                  className="flex flex-col items-center gap-2 group cursor-pointer"
                >
                  <div className={`w-16 h-16 rounded-full border-2 bg-gray-50 border-gray-100 flex items-center justify-center transition-all ${meta?.bg ?? "hover:border-blue-300 hover:bg-blue-50"}`}>
                    {meta ? meta.icon : <DefaultIcon name={cat} />}
                  </div>
                  <span className="text-xs font-medium text-gray-700 text-center group-hover:text-blue-600 transition-colors leading-tight">
                    {cat}
                  </span>
                </Link>
              );
